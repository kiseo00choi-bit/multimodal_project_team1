...
# ---------------------------------------------------------------------------
# Stage 1. RGB image -> keypoint estimator
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Stage 2. Downstream action classifiers
# ---------------------------------------------------------------------------
...
class RGBSequenceClassifier(nn.Module):
    ...
    This model has the same role as the first experiment's RGB temporal
    baseline: it uses image features only and does not receive GT or predicted
    keypoints.
    """
